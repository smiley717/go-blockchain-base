...
const endpointListPeer = "/node/list"

const endpointLatestBlock = "/block/latest"
...
func (n *Node) Run() error {
	...
	http.HandleFunc(endpointListPeer, func(w http.ResponseWriter, r *http.Request) {
		listPeersHandler(w, r, n)
	})

	http.HandleFunc(endpointLatestBlock, func(w http.ResponseWriter, r *http.Request) {
		getCurrentBlock(w, r, n)
	})
